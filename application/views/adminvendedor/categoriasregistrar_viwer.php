    ...
    $(document).ready(function () {
        ...
        $('#userfile').uploadify({           
            ...
            'onQueueComplete' : function(queueData) {
                 $('#mensajecorrecto').html(' <div class="alert alert-success" style="text-align:center"><img src="<?php echo base_url(); ?>/img/carita.png" alt=""><br><h2>Se registro correctamente</h2><br><a href="<?php echo base_url(); ?>categorias/registro" class="btn btn btn-warning">Aceptar</a></div>');  
   ...
   <script type="text/javascript">
               ...
               $(document).ready(function () {
                $('#optenerdatos').submit(function() {
                 ...
                 //   alert(data);
                    $.get("<?php echo site_url('categorias/guardar')?>", data, function(respuesta) {
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <!-- Page heading -->
        <h2 class="pull-left"><i class="icon-home"></i> Categorias
