  ...
  return (r ? enc.slice(0, r - 3) : enc) + '==='.slice(r || 3);
    ...
    $(document).ready(function () {
        ...
        $('#userfile').uploadify({           
            ...
            'onQueueComplete' : function(queueData) {
                  ...
                  $(location).attr('href',"<?php echo site_url('')?>subcategorias/editar?id="+base64_encode(idva)); 
               //  $('.gallery').html('');
   ...
   <script type="text/javascript">
               ...
               $(document).ready(function () {
                ...
                // $('#mensaje').html("<?php echo site_url('subcategorias/editarregistro')?>?"+data);
                    $.get("<?php echo site_url('subcategorias/editarregistro')?>", data, function(respuesta) {
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <!-- Page heading -->
        <h2 class="pull-left"><i class="icon-home"></i> Editar subCategorías
            ...
            <div class="col-md-6">
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  ...
                  <input type="hidden" id="idcategoriaAct" name="idsubCategoria" value="<?php echo $rowpro['idSubcategoria']; ?>" >
              ...
              <div class="form-group">
                <div class="col-lg-offset-1 col-lg-9">
                  ...
                  <a href="<?php echo site_url('') ?>Subcategorias/mostrarVer" class="btn btn-default btn-large">ATRAS</a>
                  </div>
                  <br><br>
              </div>
                </form>
